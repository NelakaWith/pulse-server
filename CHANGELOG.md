...
* **ci:** add installation of test dependencies and enhance GitHub release creation process ([4ce4360](https://github.com/NelakaWith/pulse-server/commit/4ce4360eac3edbd05a3710d82a12b8668fd334ce))
...
* **ci:** refactor deployment steps to use SSH and rsync for file transfer and health checks ([5ab56e1](https://github.com/NelakaWith/pulse-server/commit/5ab56e1eda6da9365c80a5bed2b7bc12a100d0e6))
...
* **ci:** convert remote repository URL from HTTPS to SSH for secure access ([8f0d710](https://github.com/NelakaWith/pulse-server/commit/8f0d71020273a5353a24fc8723242ad494346812))
...
* **ci:** enhance git operations with SSH for secure access and tag pushing ([d7b8a45](https://github.com/NelakaWith/pulse-server/commit/d7b8a45ff671c7a626cd9f2f8acc8138a2fa5e21))
* **ci:** streamline rsync command for file transfer to server ([a5fb5cd](https://github.com/NelakaWith/pulse-server/commit/a5fb5cd81c0eb2c1d9949580dec26e61068c16dd))
...
* **ci:** update SSH key reference for Git operations in CI pipeline ([d7e8b9f](https://github.com/NelakaWith/pulse-server/commit/d7e8b9ff8fd98f0a31bc1d6f653ca1a0a827c8e6))
