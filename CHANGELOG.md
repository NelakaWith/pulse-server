...
- Initial release of Pulse Server with Express.js and OpenRouter integration
- API key authentication and rate limiting
- GitHub API integration
- Repository enrichment endpoints
...
- Version reset to 1.0.0 for proper release cycle
...
- **ci:** update permissions handling and SSH setup for production deployment ([81f6f98](https://github.com/NelakaWith/pulse-server/commit/81f6f98978b93f79737793871865ff0cb249b6b2))
